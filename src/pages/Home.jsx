     ...
     <div className="min-h-screen bg-gray-100">
      ...
      <section className="p-8 bg-white text-center">
        ...
        <p className="text-lg mt-4">
          ...
          advanced learner, we have everything you need to improve your skills.
        </p>
      </section>
      ...
      <section className=" w-[80%] mx-auto p-8 my-element mt-5 mb-10 ">
        ...
        <div className="flex justify-center gap-8 mt-6">
          <div className="w-1/3 text-center">
            ...
            <p className="text-gray-600 mt-2">Engage with multimedia lessons to improve your Turkish.</p>
          </div>
          <div className="w-1/3 text-center">
            <h3 className="text-xl font-semibold">Practice Mode</h3>
            <p className="text-gray-600 mt-2">Test your knowledge with interactive quizzes and games.</p>
          </div>
          <div className="w-1/3 text-center">
            <h3 className="text-xl font-semibold">Community Support</h3>
            <p className="text-gray-600 mt-2">Join a community of learners for additional resources and discussions.</p>
          </div>
        </div>
      </section>
      ...
      <section className=" w-[60%]  text-white py-8 mt-6 my-element ">
        ...
        <div className="flex justify-center gap-8 mt-6">
          <div className="w-1/3 text-center">
            <p className="italic">"The best Turkish learning experience I've had. I can already hold basic conversations!"</p>
            <p className="font-bold mt-2">- Sarah K.</p>
          </div>
          <div className="w-1/3 text-center">
            <p className="italic">"Great lessons! The interactive quizzes are fun and helpful."</p>
            <p className="font-bold mt-2">- James T.</p>
          </div>
          <div className="w-1/3 text-center">
            <p className="italic">"I love the community! It's motivating to learn with others."</p>
